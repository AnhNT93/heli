class PalletsController < ApplicationController
  ...
  private
    ...
    def pallet_params
      params.require(:pallet).permit(:type_id, :ten, :gioiThieu, :nhaSanXuat, :model, :trongTai, :trongTamTai, :tocDoNang, :chieuCaoNangTieuChuan, :tocDoDiChuyen, :banKinhQuayVongToiThieu, :khaNangLeoDoc, :loaiDieuKhienLai, :motoLai, :motoBom, :acQuy, :kichThuocCangNang, :coLop, :tongKhoiLuong, :tongChieuDai, :tongChieuRong)
    end
end
