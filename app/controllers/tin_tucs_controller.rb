class TinTucsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tin_tuc.save
        format.html { redirect_to @tin_tuc, notice: 'Tin tuc was successfully created.' }
        format.json { render :show, status: :created, location: @tin_tuc }
      else
  ...
  def update
    respond_to do |format|
      if @tin_tuc.update(tin_tuc_params)
        format.html { redirect_to @tin_tuc, notice: 'Tin tuc was successfully updated.' }
        format.json { render :show, status: :ok, location: @tin_tuc }
      else
